...
<html class="no-js" lang="$ContentLocale">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="$resourceURL('themes/carwashsolutions/static/dist/typehead.css')">
        <link rel="stylesheet" type="text/css" href="$resourceURL('themes/carwashsolutions/static/dist/app.min.css')">
    </head>
